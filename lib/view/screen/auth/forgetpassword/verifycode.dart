import 'package:ecommerceapp/controller/forgetpassword/verifycodepass_controller.dart';
...
class VerifyCode extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    VerifyCodePassControllerImp controller =
        Get.put(VerifyCodePassControllerImp());
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Verification Code",
      ...
      body: GetBuilder<VerifyCodePassControllerImp>(builder: (controller) {
